<?php
// qc_dashboard.php — FIXED: reject modals moved outside <table>
session_start();
        ...
        <div class="table-responsive">
            <table class="table table-hover align-middle mb-0">
                ...
                <tr id="rollsRow<?= $pid ?>" style="display:none;">
                    <td colspan="6" style="padding:0 0 10px 50px; background:#f8faff;">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        if ($item['actual_length']) {
                                            echo ' <span style="font-size:10px;background:#dcfce7;color:#166534;
...
<!-- ═══════════════════════════════════════════════════════════
     REJECT MODALS — rendered OUTSIDE the <table>, directly
     inside <body>. Bootstrap modals MUST be top-level elements;
     placing them inside <tbody> causes the browser to strip them
     from the DOM, making data-bs-target point to nothing.
     ═══════════════════════════════════════════════════════════ -->
<?php foreach ($pallets as $pallet):
    $pid = (int)$pallet['id'];
?>
