    ...
    <div class="login-body">
      ...
      <form method="POST" autocomplete="off">
        ...
        <div class="role-switch">
          <div class="role-item">
            <input type="radio" id="role_mkl3" name="role" value="mkl3" <?= (($defaultRole ?? 'slitting') === 'mkl3') ? 'checked' : '' ?>>
            <label class="role-label" for="role_mkl3">MKL3</label>
          </div>
          <div class="role-item">
            <input type="radio" id="role_slitting" name="role" value="slitting" <?= (($defaultRole ?? 'slitting') === 'slitting') ? 'checked' : '' ?>>
            <label class="role-label" for="role_slitting">Slitting</label>
          </div>
          <div class="role-item">
            <input type="radio" id="role_qc" name="role" value="qc" <?= (($defaultRole ?? 'slitting') === 'qc') ? 'checked' : '' ?>>
        ...
        <div class="mb-3">
          ...
          <input class="form-control" type="text" name="username" placeholder="Enter username" value="<?= htmlspecialchars($username ?? '') ?>" required>
        </div>
