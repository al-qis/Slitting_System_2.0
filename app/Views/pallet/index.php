<?php
if (!function_exists('formatWidthDisplay')) {
    function formatWidthDisplay($val): string {
        return \App\Models\Pallet::formatWidthDisplay($val);
    }
}
if (!function_exists('calcEstWeight')) {
    function calcEstWeight(float $lengthM, float $widthMm, float $stdWeight): float {
        return \App\Models\Pallet::calcEstWeight($lengthM, $widthMm, $stdWeight);
    }
}
